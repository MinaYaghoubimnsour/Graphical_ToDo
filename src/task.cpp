...
void task::loadCircleTexture()
{
  if (isCompleted)
  {
    circle.loadFromFile("/mnt/c/Users/Parsian.system/Desktop/test/Graphical_ToDo/checkmark.png");
  }
  else
  {
    circle.loadFromFile("/mnt/c/Users/Parsian.system/Desktop/test/Graphical_ToDo/circle.png");
  }
}
...
{
  trash.loadFromFile("/mnt/c/Users/Parsian.system/Desktop/test/Graphical_ToDo/trash.png");
}
...
{
  if (!favorite)
    star.loadFromFile("/mnt/c/Users/Parsian.system/Desktop/test/Graphical_ToDo/Star.png");
  else
    star.loadFromFile("/mnt/c/Users/Parsian.system/Desktop/test/Graphical_ToDo/yellowStar.png");
}
...
{
  pencil.loadFromFile("/mnt/c/Users/Parsian.system/Desktop/test/Graphical_ToDo/pencil .png");
}
